...
class OODScore:
    ...
    def metrics_json_path(self):
        return os.path.join(self.path_to_cache, 'scores', 'metrics_xmaha_table2.json')
...
def _run_model_pipeline(model, current_dataset, args, task, methods):
    ...
    task.setup(current_dataset, model,
               ood_dataset_paths_prefix=args.dataset_paths_prefix,
               clip_model=False,
               val_dir_override=args.val_dir,
