...
By default the script uses a cached ImageNet-LT ViT-B/16 run where MM++ gives a
large FPR@95 reduction on ImageNet-C. Use --model and --dataset to regenerate
...
# FPR@95 values from the ImageNet-LT main results table (ViT-B/16):
# (Maha++, MM++ (Ours)) per OOD benchmark.
TABLE_FPR_VALUES = OrderedDict([
    ('NINCO_OOD_classes', (47.30, 43.20)),
    ('openimages_o',      (24.55, 20.98)),
    ('imagenet_c',        (73.05, 53.80)),
    ('imagenet_es',       (73.09, 52.43)),
    ('imagenet_r',        (46.92, 41.83)),
    ('imagenet_v2',       (89.37, 88.94)),
])
...
def parse_args():
    ...
    parser.add_argument('--out-prefix', default=os.path.join(OUT_DIR, 'mmpp_teaser'))
